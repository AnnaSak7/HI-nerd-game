...
export default class HelloWorldScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('invader1', './assets/java.png', {
      frameWidth: 32,
      frameHeight: 32,
    });
    ...
    this.load.spritesheet('invader3', './assets/kotlin.png', {
      frameWidth: 48,
      frameHeight: 32,
    });
  ...
  create() {
    ...
    this.physics.add.collider(
      this.bullets,
      enemy2,
      function (bulletCollide, enemy2Collide) {
        enemy2Collide.destroy();
        bulletCollide.destroy();
      }.bind(this)
    );
  }
